            ...
            <transition name="slideleft" v-if="$settings.sections.blog.sidebar.active">
                <div :class="showSideBar ? 'show':'hide'" class="w-80  fixed hidden h-full top-0 left-0 bottom-0 bg-white z-10">
                    ...
                    <div class="border-r bg-white h-full flex flex-col relative">
                        <div class="w-full flex justify-end">  <!-- block  -->
                        ...
                        <h3 v-if="$settings.sections.blog.sidebar.categories.active" class="px-2">{{ $settings.sections.blog.sidebar.categories.title }}</h3>
                    ...
                    <div class="mb-8">
                        <div class="flex justify-between items-center p-2">
                            <div class="flex items-center">
                              <button @click="showSideBar = true" aria-label="Search button" class="flex items-center flex-col p-2  rounded-md mx-1 "><!-- block  -->
                            ...
                            <select class="bg-white p-2 rounded-2xl shadow outline-none" v-model="params.sort">
...
<style>
  ...
  position: relative;
    ...
    background-image: url("https://cdn.shopify.com/s/files/1/0616/9480/4174/articles/young-woman-1149643_1920-7-1_1512x.jpg?v=1653266995");
}
