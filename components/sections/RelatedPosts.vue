<template>
  <div class="container" v-if="items.length > 0">
    <div class="m-2">
      <h2 class="post_title text-center">{{ $settings.sections.post.related.title }}</h2>
    </div>
    ...
    <div class="flex justify-center" v-if="$settings.sections.posts.show_more_text">
      <nuxt-link class="btn_link flex items-center py-2 px-4 w-60 mx-2 text-center shadow border-2 border-black rounded-full" to="/blog">
