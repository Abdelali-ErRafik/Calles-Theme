<template>
  <div class="container">
    <div class="m-2 mt-10">
      <h2 class="title text-center flex justify-center items-center ">
        <span class="">{{ title }}</span>
      </h2>
      <h5 class="text-center sub_title">Top view in this week</h5>
    </div>
    ...
    <div class="flex flex-wrap">
      <div v-for="(item, i) in items" :key="i" class="w-1/2 sm:w-1/2 md:w-1/3 lg:w-1/4 p-2">
    ...
    <div class="flex justify-center" v-if="section.show_more_text">
      <nuxt-link class="btn_link flex items-center py-2 px-4 w-48 mx-2 text-center shadow border-2 border-black rounded-full" :to="section.show_more_url">
        <span class="w-full text-black">{{ section.show_more_text }}</span>
